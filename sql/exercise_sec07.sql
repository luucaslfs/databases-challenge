...
-- 2. Select product name and order time for Sabonetes sold between January 15th 2017 and Feb 14th. 2017

SELECT p.name, o.order_time FROM products p
JOIN orders o ON p.id = o.product_id
WHERE p.name = 'Sabonete'
AND o.order_time BETWEEN '2017-01-15' AND '2017-02-14'; 

-- 3. Select the product name and price and order time for all orders from females in Jan 2017.
